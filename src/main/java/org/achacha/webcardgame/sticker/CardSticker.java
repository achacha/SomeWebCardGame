...
public abstract class CardSticker implements JsonEmittable {
     ...
     */
    public CardSticker(Type type, String messageKeyBase) {
        this.type = type;
    ...
    /**
     * All data and info about the card are stored in the Type and generated by the factory
